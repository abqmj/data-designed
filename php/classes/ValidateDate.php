...
/**
 * Trait for validating the date in mySQL Date
 *
 * This will inject a private method to validate a mySQL style date. Will convert a string representation to a DateTime object or throw an exception.
 **/
trait ValidateDate {
	/**
